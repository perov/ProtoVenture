...
shared_ptr<VentureValue> Primitive__RealEqualOrGreater::Sampler(vector< shared_ptr<VentureValue> >& arguments) {
  if (arguments.size() != 2) {
    throw std::exception("Wrong number of arguments.");
  }
...
shared_ptr<VentureValue> Primitive__RealEqualOrLesser::Sampler(vector< shared_ptr<VentureValue> >& arguments) {
  if (arguments.size() != 2) {
    throw std::exception("Wrong number of arguments.");
  }
...
shared_ptr<VentureValue> Primitive__RealGreater::Sampler(vector< shared_ptr<VentureValue> >& arguments) {
  if (arguments.size() != 2) {
    throw std::exception("Wrong number of arguments.");
  }
...
shared_ptr<VentureValue> Primitive__RealLesser::Sampler(vector< shared_ptr<VentureValue> >& arguments) {
  if (arguments.size() != 2) {
    throw std::exception("Wrong number of arguments.");
  }
...
shared_ptr<VentureValue> Primitive__RealEqual::Sampler(vector< shared_ptr<VentureValue> >& arguments) {
  if (arguments.size() != 2) {
    throw std::exception("Wrong number of arguments.");
  }
