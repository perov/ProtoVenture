...
def add():
  ...
  venture_engine.predict("r[5]")
  # venture_engine.assume("a", parse("(+ r[0.0] r[1.0])"))
  # venture_engine.observe(parse("(normal a r[0.01])"), "r[0.7]")
  return 1 #venture_engine.report_value(1)

jid = cloud.call(add, _env='venture-yura', _type='f2')
