...
class Primitive__RealEqualOrGreater : public Primitive {
  virtual shared_ptr<VentureValue> Primitive__RealEqualOrGreater::Sampler(vector< shared_ptr<VentureValue> >& arguments);
public:
  virtual string Primitive__RealEqualOrGreater::GetName();
};

class Primitive__RealEqualOrLesser : public Primitive {
  virtual shared_ptr<VentureValue> Primitive__RealEqualOrLesser::Sampler(vector< shared_ptr<VentureValue> >& arguments);
public:
  virtual string Primitive__RealEqualOrLesser::GetName();
};

class Primitive__RealGreater : public Primitive { // Useless for Real?
  virtual shared_ptr<VentureValue> Primitive__RealGreater::Sampler(vector< shared_ptr<VentureValue> >& arguments);
public:
  virtual string Primitive__RealGreater::GetName();
};

class Primitive__RealLesser : public Primitive { // Useless for Real?
  virtual shared_ptr<VentureValue> Primitive__RealLesser::Sampler(vector< shared_ptr<VentureValue> >& arguments);
public:
  virtual string Primitive__RealLesser::GetName();
};

class Primitive__RealEqual : public Primitive { // With epsilon.
  virtual shared_ptr<VentureValue> Primitive__RealEqual::Sampler(vector< shared_ptr<VentureValue> >& arguments);
public:
